...
class StudyMemberMapper {
  ...
  static StudentEntity toEntity(StudyApplicant a) => StudentEntity(
    ...
    grade: a.grade ?? StudentFormatter.parseGrade(a.studentNumber),
    classNumber:
        a.classNumber ?? StudentFormatter.parseClassNumber(a.studentNumber),
    number: a.number ?? StudentFormatter.parseNumber(a.studentNumber),
    gender: Gender.getString(a.sex),
  );
}
